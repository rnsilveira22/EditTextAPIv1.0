...
//					System.out.println("|     "+doc.getId()+"       | "+doc.getTitulo()+" | "+doc.getCorpo()+" |"+doc.getData()+" |");
//				}
//				System.out.println("------------------------------------------------------");
